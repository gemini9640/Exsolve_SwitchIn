...
<%
request.setAttribute("title", "Tables - Rejected Voucher");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Rejected Voucher</li>
						</ul>
					</div>
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Rejected Voucher dataTables</h3>
										<div class="pull-left">
			...
			<script type="text/javascript">
				switchLeftActive("voucher", null, "voucherRejected");
			</script>
	...
	if(result.status == 0) {
		...
		for(var key in data) {
			...
			tr += "<tr>"+
					...
					"<td><textarea class='dataValue'>"+voucher.rejectReason+"</textarea></td>"+
					"<td>"+
