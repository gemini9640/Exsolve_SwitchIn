					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">ExL-Client dataTables</h3>
										<div class="pull-left">
											...
											<div class="row">
												<div class="col-xs-3" style="float:left;">
													<div class="input-group">
														...
														<input class="form-control" type="text" name="date-range-picker" id="exlclient-date-range-picker" />
													</div>
												</div>
										...
										<div class="table-header">
											Results for "ExL-Client Listing"
										</div>
										<div class="dataTables_wrapper">
											<div id="sample-table-2_length" class="row exl_client_sizeSelector" style="padding-bottom: 0px;">
											</div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody class="tabaleData_exl_client">
												</tbody>
											</table>
											<div class="row exl_client_pageInfo">
											</div>
										</div>
									</div>
								</div>
...
<script>
$.DateTimeConfig.init("#exlclient-date-range-picker");
$.TableDataConfig.generateSizeSelector("exl_client", 25);

function exl_client_list(pageNumber) {
	var dateRange = new $.DateTimeConfig.DateRange($('#exlclient-date-range-picker').val());
	$(".tabaleData_exl_client").html("");
	$.post("${base}manage/exlclient/listPageByProperties.do", {
		start : dateRange.start,
		end : dateRange.end,
		pageNum : pageNumber,
		pageSize : $("#exl_client_size_selected").val()
	},function(result) {
		exl_client_html(result);
	});
}

function exl_client_html(result) {
	if(result.status == 0) {
			...
			tr += "<tr id='tr_"+exlclient.id+"'>"+
					...
					"<td>"+
						"<div class='hidden-sm hidden-xs action-buttons'>"+
							...
							"</a>"+
							"<a class='green'  href='${base}manage/exlclient/detail.do?id="+exlclient.id+"'>"+
		...
		$(".tabaleData_exl_client").html(tr);
		$.JsUtil.undefinedRed(".dataValue");	
		$.TableDataConfig.pagination("exl_client", pageResp.pageSize, pageResp.navigatepageNums, pageResp.pageNum, pageResp.startRow, pageResp.endRow, pageResp.total);
	}
}
exl_client_list(1);
