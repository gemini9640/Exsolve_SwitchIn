...
<%
request.setAttribute("title", "Tables - Active Voucher");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Active Voucher</li>
						</ul>
					</div>
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Active Voucher dataTables</h3>
										<div class="pull-left">
			...
			<script type="text/javascript">
				switchLeftActive("voucher", null, "voucherActive");
			</script>
