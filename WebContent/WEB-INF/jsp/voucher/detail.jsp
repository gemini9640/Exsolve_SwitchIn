														...
														<div id="create-voucher" class="tab-pane in active">
															...
															<div class="row">
																<div class="col-xs-12 col-sm-10"><div class="form-group"><!--  has-error -->
																	<label class="col-sm-2 control-label no-padding-right" for="form-field-id">Voucher Id</label>
																		<div class="col-sm-10">
																			<input class="col-xs-12 col-sm-10" type="text" id="form-field-id" placeholder="" value="${voucher.id}" disabled/>
																		</div>
																	</div>
																	<div class="form-group"><!--  has-error -->
																		<label class="col-sm-2 control-label no-padding-right" for="form-field-vouchertitle">Voucher Title</label>
																		<div class="col-sm-10">
																			<input name="voucherTitle" class="col-xs-12 col-sm-10" type="text" id="form-field-vouchertitle" placeholder="" value="${voucher.voucherTitle}" />
<!-- 																			<div class="help-block col-xs-12 col-sm-reset inline">* Please Enter Voucher Title.</div> -->
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-2">
																			...
																			<script>
																				$("#form-field-select-voucherType").find("option[value='${voucher.voucherType}']").attr("selected",true);
																			</script>
																		</div>
																	</div>
																	<div class="form-group">
																		...
																		<div class="col-sm-10">
																			<div class="input-medium">
																				<div class="input-group">
																					<input name="startDate" value="<fmt:formatDate value="${voucher.startDate}" pattern="dd-MM-yyyy"/>" class="input-medium date-picker" id="form-field-date-startdate" type="text" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" />
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-10">
																			<div class="input-medium">
																				<div class="input-group">
																					<input name="endDate" value="<fmt:formatDate value="${voucher.endDate}" pattern="dd-MM-yyyy"/>" class="input-medium date-picker" id="form-field-date-enddate" type="text" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" />
																					<span class="input-group-addon">
																						<i class="ace-icon fa fa-calendar"></i>
																					</span>
																				</div>
...
<%-- 																					<input value="${voucher.starttime}" name="starttime" id="startTime" type="text" class="form-control" /> --%>
<!-- 																					<span class="input-group-addon"> -->
...
<!-- 																			<div class="input-medium"> -->
<!-- 																				<div class="input-group bootstrap-timepicker"> -->
<%-- 																					<input value="${voucher.endtime}" name="endtime" id="endTime" type="text" class="form-control" /> --%>
<!-- 																					<span class="input-group-addon"> -->
<!-- 																						<i class="fa fa-clock-o bigger-110"></i> -->
<!-- 																					</span> -->
<!-- 																				</div> -->
...
<!-- 																	</div> -->
																	<div class="form-group">
																		...
																		<div class="col-sm-10">
																			<input name="address" value="${voucher.address}" class="col-xs-12 col-sm-10" type="text" id="form-field-address" placeholder="" value="" />
																		</div>
																	</div>
																	<div class="form-group">
																		...
																		<div class="col-sm-10">
																			<span class="input-icon input-icon-right">
																				<input name="csphone" value="${voucher.csphone}" class="" type="text" id="form-field-csphone" />
															...
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<span>
																		<input name="merchantId" value="${voucher.merchantId}" type="text" value="" id="form-field-merchantId" />
																	</span>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<span class="input-icon">
 																		<!--name = facebook  -->
																		<input name="facebook" type="text" value="${voucher.facebook}" value="" id="form-field-facebook" />
															...
															<div class="form-group">
																...
																<div class="col-sm-10">
																	<span class="input-icon">
																		<!--name = instagram  -->
																		<input name="instagram" type="text" value="${voucher.instagram}" id="form-field-instagram" />
															...
															<div class="form-group">
																...
																<div class="col-sm-10">
																<textarea name="description" id="form-field-11" class="autosize-transition form-control">${voucher.description}</textarea>
																</div>
															</div>
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-right" for="form-field-reminder">Reminder</label>
																<div class="col-sm-10">
																<textarea name="reminder" id="form-field-reminder" class="autosize-transition form-control">${voucher.reminder}</textarea>
																</div>
															</div>
															<div class="form-group">
																<label class="col-sm-2 control-label no-padding-right" for="form-field-tnc">Term & Condition</label>
																<div class="col-sm-10">
																<textarea name="tnc" id="form-field-tnc" class="autosize-transition form-control">${voucher.tnc}</textarea>
																</div>
															</div>
														</div>
