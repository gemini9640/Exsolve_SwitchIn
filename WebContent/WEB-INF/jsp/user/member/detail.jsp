									...
									<div id="user-profile-3" class="user-profile row">
										<div class="col-sm-offset-0 col-sm-12">
											...
											<form action="${base}manage/member/edit.do" method="post" class="form-horizontal" enctype="multipart/form-data">
												<input type="hidden" name="username" value="${result.member.username}">
												<div class="tabbable">
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-10">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-10">
																			<input name="username" class="col-xs-12 col-sm-10" type="text" id="form-field-username" placeholder="" value="${result.member.username}" disabled="disabled"/>
																		</div>
																	</div>
																	<%--
																	<div class="form-group">
