...
<%
request.setAttribute("title", "Tables - Expired Event");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Expired Event</li>
						</ul>
					</div>
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">Expired Event dataTables</h3>
										<div class="pull-left">
			...
			<script type="text/javascript">
				switchLeftActive("event", null, "eventExpired");
			</script>
